...
credit ="Alex:)™~" 
OWNER = int(os.environ.get("OWNER", 6408974968))
try: 
    ADMINS=[] 
    for x in (os.environ.get("ADMINS", "6408974968").split()):  
        ADMINS.append(int(x)) 
except ValueError: 
...
bot = Client("bot",    
   bot_token="7906929478:AAEAFRFB-ZnPp84qyvXpj-Rdzy8oEjamMJM",    
   api_id= 29557021,    
   api_hash= "369274ecf18e5978daf97b53966862ea"
)
